...
# 设定监控日志输出文件名和内容形式
logging.basicConfig(format='%(asctime)s - %(message)s', filename='/home/MicroReports/workspace/TB-seq/OUTPUT/运行信息.txt', filemode='a', level=logging.INFO)
...
parser.add_argument('-c', "--complex_excel", type=str, default='/home/MicroReports/pipelines/TB-seq/mycobacterium_tuberculosis_complex.xlsx',help="结核分枝杆菌复合群包含微生物表格")
parser.add_argument('-s', "--summary_excel", type=str, default='/home/MicroReports/workspace/TB-seq/OUTPUT/',help="summary documents before processing")
parser.add_argument('-m', "--name_excel", type=str, default='/home/MicroReports/pipelines/TB-seq/药品中英文对照表.xlsx',help="检测药品中英文对照表")
parser.add_argument('-o', "--output_dir", type=str, default='/home/MicroReports/workspace/TB-seq/OUTPUT/',help="supplement sample result")
...
for sample_code in dic_client.keys():
    ...
    if '耐药基因' in project:
        ...
        doc = DocxTemplate(f'/home/MicroReports/pipelines/TB-seq/{agent}/分枝杆菌(MTB&NTM)及其耐药基因检测报告.docx')
