...
parser.add_argument('-P', "--picard", required=True,  help="输入文件:picard.jar所在路径")
...
cmd11=f'''vardict -G {args.ref} -N {args.prefix} -b {out_dir}{args.prefix}.consensus.merge.filter.clip.BAM -z -c 1 -S 2 -E 3 -g 4 -th 4 {args.target} >{out_dir}{args.prefix}.vcf'''
print(cmd11)
os.system(cmd11)
